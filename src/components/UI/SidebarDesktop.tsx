...
export const SideBarDesktop = () => {
  ...
  return (
    <>
      <div
        className={`h-full w-[250px] overflow-auto bg-gray-200 duration-300 ease-in-out
        ...
        <div className="flex h-20 w-full justify-around items-center p-2 bg-gray-600 shadow-lg dark:bg-slate-900 dark:shadow-slate-850">
      ...
      {!isOpen ? (
        <div className="absolute p-4 text-white z-10 flex gap-3">
